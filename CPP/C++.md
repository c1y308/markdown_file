...
3. xxxxxxxxxx29 1# 将fork的项目 clone 到本地2git clone https://github.com/你的用户名/项目名.git3cd 项目名4​5# 把原始仓库命名为 upstream 进行链接，方便追踪原仓库的更新6git remote add upstream https://github.com/原始作者/项目名.git7​8# 1. 确保本地/远程仓库的 main 分支是最新的"版本"9git checkout main10git fetch upstream11git merge upstream/main        # 现在 main = 官方最新代码12git push origin main           # 同步到你的 GitHub fork13# 2. 切换到正在开发的功能分支14git checkout feature-xxx15# 3. 将最新官方代码合并到你的功能分支（二选一）16# 方案 A：合并（merge）- 保留历史，有合并提交17git merge main18# 方案 B：变基（rebase）- 线性历史，无合并提交，更干净19git rebase main20​21​22# 创建新分支23git checkout -b 你的分支名24​25# 进行代码修改后26git add .27git commit -m "描述性提交信息"28​29git push origin 你的分支名sh
